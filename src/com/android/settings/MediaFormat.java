...
public class MediaFormat extends Activity {
    ...
    private boolean isUhost(){
        boolean isRemovable = mVolume != null ? mVolume.isRemovable() : false;
        boolean uhost = false;
        if(isRemovable){
    ...
    private void establishFinalConfirmationState() {
        if (mFinalView == null) {
            if(!mUhost){
                ...
                setTitle(R.string.media_format_uhost_title);
                mFinalView = mInflater.inflate(R.layout.media_format_uhost_final, null);
                mFinalButton =
                    (Button) mFinalView.findViewById(R.id.execute_media_format_uhost);
            }
    ...
    private void establishInitialState() {
        if (mInitialView == null) {
            if(!mUhost){
                ...
                setTitle(R.string.media_format_uhost_title);
                mInitialView = mInflater.inflate(R.layout.media_format_uhost_primary, null);
                mInitiateButton =
                    (Button) mInitialView.findViewById(R.id.initiate_media_format_uhost);
            }
    ...
    protected void onCreate(Bundle savedState) {
        ...
        mVolume = getIntent().getParcelableExtra(
                        StorageVolume.EXTRA_STORAGE_VOLUME);
        mUhost = isUhost();

        ...
        if (intent != null) {
            ...
            for (int i = 0; i < listSize; i++) {
                ...
                if ((resolveInfo.activityInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM)
                    ...
                    Intent preInt = new Intent();
                    preInt.setClassName(resolveInfo.activityInfo.packageName,
                            resolveInfo.activityInfo.name);
                    if(DeviceInfoSettings.KEY_SYSTEM_UPDATE_SETTINGS.equals(preferenceKey)) {
                        preInt.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    }
                    
                    preference.setIntent(preInt);

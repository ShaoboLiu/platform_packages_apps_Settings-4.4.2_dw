...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSupportCvbs = false;
        mSupportHdmi = getPackageManager().hasSystemFeature(PackageManager.ACTIONS_FEATURE_TVOUT_HDMI);
	...
	//			|| getMemoryTotalSizeFromProp() <= 512) {
        }
	...
	private void updateTvoutMenuStatus(boolean isPlugIn) {
		...
		//if(SystemProperties.getInt("ro.config.hdmi", 0) ==1) {

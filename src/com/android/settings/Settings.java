...
public class Settings extends PreferenceActivity
    ...
    //ActionsCode(authro:songzhining, comment: add forceTableUI support)
    private boolean forceTabetUI = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ActionsCode(authro:songzhining, comment: add forceTableUI support)
        forceTabetUI = SystemProperties.getInt("ro.config.forcetabletui", 0) > 0;
    ...
    public boolean onIsMultiPane() {
        //ActionsCode(authro:songzhining, comment: add forceTableUI support)
        return forceTabetUI || super.onIsMultiPane();
    }
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            if (id == R.id.operator_settings || id == R.id.manufacturer_settings) {
                ...
                if (SystemProperties.get("ro.settings.support.wifi","true").equals("false")) {
                    target.remove(i);
                }else{
                ...
                if(SystemProperties.get("ro.settings.support.bluetooth", "true").equals("false")) {
                    target.remove(i);
                }else{
                ...
                if(SystemProperties.get("ro.settings.support.ethernet", "true").equals("false")) {
                    target.remove(header);
                }
            } else if (id == R.id.data_usage_settings) {
                if(SystemProperties.get("ro.settings.datausage", "true").equals("false")) {
                    target.remove(i);
                }else{
                ...
                if(SystemProperties.get("ro.settings.support.location", "true").equals("false")) {
                    target.remove(i);
                }
            }
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private final EthernetEnabler mEthernetEnabler; // Alicia add 12.04.25
        ...
        static int getHeaderType(Header header) {
            ...
            } else if (header.id == R.id.wifi_settings || header.id == R.id.ethernet_settings || header.id == R.id.bluetooth_settings) {
    ...
    public static class EthernetSettingsActivity extends Settings {/* empty */ } //Alicia add 2012.04.25

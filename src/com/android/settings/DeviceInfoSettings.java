...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    public static final String KEY_SYSTEM_UPDATE_SETTINGS = "system_update_settings";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setStringSummary(KEY_DEVICE_SERIALNO, Build.SERIAL);
        ...
        if (Utils.isWifiOnly(getActivity()) || getMobileDataState(getActivity()) == TelephonyManager.DATA_DISCONNECTED) {

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnClickListener confirmListener = new OnClickListener() {
            public void onClick(View v) {
                Log.d(LOG_TAG, "confirmListener onClick curScales[0]=" + curScales[0] + ",curScales[1]=" + curScales[1]);
                Editor hdmi_scales = getSharedPreferences(HDMI_SCALES, Context.MODE_PRIVATE).edit();
                hdmi_scales.putBoolean("save_flag", true);
                hdmi_scales.putInt("hdmi_scale_x", curScales[0]);
                hdmi_scales.putInt("hdmi_scale_y", curScales[1]);
                hdmi_scales.commit();
                finish();
            }
        };

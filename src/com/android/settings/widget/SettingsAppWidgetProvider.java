...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    private static final int BUTTON_RUN_MODE = 5;
    ...
    static RemoteViews buildUpdate(Context context) {
        ...
        views.setViewVisibility(R.id.btn_location, View.GONE);
        ...
        views.setOnClickPendingIntent(R.id.btn_bluetooth,
                getLaunchPendingIntent(context,
                        BUTTON_BLUETOOTH));
        views.setOnClickPendingIntent(R.id.btn_runmode, 
                getLaunchPendingIntent(context, 
                        BUTTON_RUN_MODE));
    ...
    private static void updateButtons(RemoteViews views, Context context) {
        ...
        if (getBrightnessMode(context)) {
            ...
            views.setImageViewResource(R.id.ind_brightness,
                    R.drawable.appwidget_settings_ind_on_r_holo);
        } else if(getIntelligentBrightnessMode(context)){
            views.setContentDescription(R.id.btn_brightness,
                    context.getString(R.string.gadget_brightness_template,
                            context.getString(R.string.gadget_brightness_state_intellignet)));
            views.setImageViewResource(R.id.img_brightness,
        ...
        // run mode
        if(AccessibilitySettings.getPerformanceMode().equals("interactive")) {
            views.setContentDescription(R.id.btn_brightness,
                    context.getString(R.string.gadget_runmode_template,
                            context.getString(R.string.gadget_runmode_state_interactive)));
            views.setImageViewResource(R.id.img_runmode,
            R.drawable.ic_appwidget_settings_runmode_interactive_holo);
            views.setImageViewResource(R.id.ind_runmode,
            R.drawable.appwidget_settings_ind_off_r_holo);
        } else if(AccessibilitySettings.getPerformanceMode().equals("ondemand")) {
            views.setContentDescription(R.id.btn_brightness,
                    context.getString(R.string.gadget_runmode_template,
                            context.getString(R.string.gadget_runmode_state_ondemand)));
            views.setImageViewResource(R.id.img_runmode,
            R.drawable.ic_appwidget_settings_runmode_ondemand_holo);
            views.setImageViewResource(R.id.ind_runmode,
            R.drawable.appwidget_settings_ind_on_r_holo);
        } else if(AccessibilitySettings.getPerformanceMode().equals("performance")) {
            views.setContentDescription(R.id.btn_brightness,
                    context.getString(R.string.gadget_runmode_template,
                            context.getString(R.string.gadget_runmode_state_performance)));
            views.setImageViewResource(R.id.img_runmode,
            R.drawable.ic_appwidget_settings_runmode_performance_holo);
            views.setImageViewResource(R.id.ind_runmode,
            R.drawable.appwidget_settings_ind_on_r_holo);
        }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(action)) {
            ...
            } else if (buttonId == BUTTON_RUN_MODE) {
                toggleRunMode(context);
            }
        } else if (action.equals("com.android.actions.RUN_MODE_STATUS_CHANGED")) {
            // use updateWidget to update the ui
        } else {
    ...
    public void toggleRunMode(Context mContext) {
        String mode = AccessibilitySettings.getPerformanceMode();
        if(!SystemProperties.get("ro.settings.runmode.performance", "0").equals("0")){
            if(mode.equals("interactive")){
                AccessibilitySettings.setPerformanceMode("performance");
                Toast.makeText(mContext, mContext.getString(R.string.gadget_runmode_state_performance), Toast.LENGTH_SHORT).show();
            } else if(mode.equals("ondemand")){
                AccessibilitySettings.setPerformanceMode("interactive");
                Toast.makeText(mContext, mContext.getString(R.string.gadget_runmode_state_interactive), Toast.LENGTH_SHORT).show();
            } else if(mode.equals("performance")) {
                AccessibilitySettings.setPerformanceMode("ondemand");
                Toast.makeText(mContext, mContext.getString(R.string.gadget_runmode_state_ondemand), Toast.LENGTH_SHORT).show();
            }
        }else{
            if(mode.equals("interactive")){
                AccessibilitySettings.setPerformanceMode("ondemand");
    ...
    private static boolean getIntelligentBrightnessMode(Context context) {
    ...
    private void toggleBrightness(Context context) {
        try {
            ...
            if (power != null) {
                ...
                boolean intelligentBrightnessMode = getIntelligentBrightnessMode(context);
                ...
                if (brightnessMode == Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC) {
                    ...
                    brightnessMode = Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL;
                } else if(intelligentBrightnessMode){
                    //just return in intelligent mode;
                    Toast.makeText(context, context.getString(R.string.gadget_brightness_state_intellignet), Toast.LENGTH_SHORT).show();
                    return;
    ...
    private static class SettingsObserver extends ContentObserver {
        ...
        void startObserving() {
            ...
            resolver.registerContentObserver(Settings.System
                    .getUriFor(mIntelligentSettingsName), false, this);
        }

...
*/
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        //ActionsCode(authro:songzhining, comment: enable option menu for msc)
    ...
    public Dialog onCreateDialog(int id) {
        String uhostPath = Environment.getUhostStorageDirectory().getPath();
        boolean isUhost = false;
        if(sClickedMountPoint.startsWith(uhostPath)){
            isUhost = true;
        }
        switch (id) {
        case DLG_CONFIRM_UNMOUNT:
                return new AlertDialog.Builder(getActivity())
                    .setTitle(isUhost? R.string.uh_dlg_confirm_unmount_title: 
                    ...
                    .setMessage(isUhost? R.string.uh_dlg_confirm_unmount_text : R.string.dlg_confirm_unmount_text)
                    .create();
        case DLG_ERROR_UNMOUNT:
                return new AlertDialog.Builder(getActivity())
            .setTitle(isUhost? R.string.uh_dlg_error_unmount_title : R.string.dlg_error_unmount_title)
            .setNeutralButton(R.string.dlg_ok, null)
            .setMessage(isUhost ? R.string.uh_dlg_error_unmount_text : R.string.dlg_error_unmount_text)
            .create();
        }
        return null;
    }
    ...
    private void doUnmount() {
        ...
        Toast.makeText(getActivity(),(isUhost ? R.string.uh_unmount_inform_text : R.string.unmount_inform_text), Toast.LENGTH_SHORT).show();
